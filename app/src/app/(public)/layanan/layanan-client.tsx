...
export default function KatalogLayananClient({
  initialServices,
  categories,
}: {
  ...
  const filtered = useMemo(() => {
    let result = initialServices.filter((s) => s.isActive);
    if (search) {
    ...
    return result;
  }, [initialServices, search, activeCategory, sortBy]);
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <Link href={`/layanan/${service.slug}`} className="hover:underline">
